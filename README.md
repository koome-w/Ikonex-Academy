...
3. Import `db.sql` into MySQL using phpMyAdmin or the MySQL command line.
...
- Use `student_report.php` or `class_report.php` and the browser print dialog to save PDF reports.
